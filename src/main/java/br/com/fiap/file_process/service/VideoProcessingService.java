...
public class VideoProcessingService {
    ...
    public VideoProcessingService(S3StorageService s3StorageService, EmailService emailService) {
    ...
    public String processVideoAndUpload(MultipartFile video, String email, String videoId) throws Exception {
        ...
        try {
            ...
            framesDir = Files.createTempDirectory("frames-").toFile();
            VideoFrameExtractor.extractFrames(tempVideo, framesDir);

            zip = File.createTempFile("frames-", ".zip");
